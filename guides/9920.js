...
exports.guide = (mod, extras) => {
	...
	function thirdboss_set_clockwise_event(clockwise, ent){
		...
		mod.setTimeout(() => {
			...
			for(let i = 0; i < 3; i++){
				...
				mod.setTimeout(() => { create.marker(false, COLOURS_OFFSETS[current_colour], (i + 1) * 3000, true, null); }, i * 2600);
			}
	...
	return {
		...
		"nd-920-3000-0": [{ type: "stop_timers" },
			{ type: "despawn_all" }],
