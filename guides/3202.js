...
module.exports = (mod, extras) => {
	return {
		...
		"s-3202-1000-123-0": [{ type: "spawn", function: "vector", args: [912, 0, 295, 295, 550, 1500] },
			{ type: "spawn", function: "vector", args: [912, 0, 85, 85, 550, 1500] },
		...
		"s-3202-1000-127-0": [{ type: "text", message: "Out-waves: Stay Out > Get In" },
			{ type: "spawn", function: "circle", args: [false, 445, 0, 0, 14, 160, 3000] },
		...
		"s-3202-1000-126-0": [{ type: "spawn", function: "vector", args: [912, 0, 295, 295, 550, 1500] },
			{ type: "spawn", function: "vector", args: [912, 0, 85, 85, 550, 1500] },
			{ type: "spawn", function: "semi", args: [85, 295, 912, 0, 0, 6, 550, 1500] },
