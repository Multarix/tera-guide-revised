...
module.exports = (mod, extras) => {
	...
	return {
		...
		// "s-3103-1000-101-0": [{ type: "text", position: "tank", message: "Punch" }],
		"s-3103-1000-113-0": [{ type: "text", position: "tank", message: "Roundhouse Kick" }],
		"s-3103-1000-111-0": [{ type: "text", position: "tank", message: "Knockdown" }],
		"s-3103-1000-120-0": [{ type: "text", position: "tank", message: "Knockdown" }],
		// "s-3103-1000-102-0": [{ type: "text", position: "tank", message: "Combo" }], // 102 153/154 115/116
		"s-3103-1000-153-0": [{ type: "text", position: "tank", message: "Two Kicks" }], // 153 108
		// "s-3103-1000-108-0": [{ type: "text", position: "tank", message: "Floor Punch" }],
		// "s-3103-1000-127-0": [{ type: "text", position: "tank", message: "Many Kicks" }],

		"s-3103-1000-121-0": [{ type: "text", message: "Flip Kick (Stun)" }],
		"s-3103-1000-107-0": [{ type: "text", message: "Bait" }, { type: "function", function: skilld_event, args: [107] }],
		"s-3103-1000-110-0": [{ type: "text", message: "Spin" }, { type: "spawn", function: "circle", args: [true, 553, 0, 0, 12, 420, 3000] }],
		"s-3103-1000-114-0": [{ type: "text", message: "Leap (Knockdown)" }, { type: "spawn", function: "circle", args: [true, 553, 0, 0, 12, 240, 2000] }],
		// "s-3103-1000-154-0": [{ type: "text", message: "Jumping Kick" }], // 154 310 116
		"s-3103-1000-310-0": [{ type: "text", message: "Back Flip | Haymaker" }, { type: "function", function: skilld_event, args: [310] }], // 310 116
		"s-3103-1000-116-0": [{ type: "function", function: skilld_event, args: [116] }], // Haymaker
		...
		"qb-3103-1000-31031007": [{ type: "text", message: "Target" },
			{ type: "function", function: skilld_event, args: [31031007] }],
		...
		"s-3103-1000-148-0": [{ type: "spawn", function: "circle", args: [true, 912, 0, -10, 12, 300, 3000] }],
		"s-3103-1000-129-0": [{ type: "text", message: "Back Wave" },
			{ type: "spawn", function: "vector", args: [912, 90, 390, 390, 300, 2000] },
			{ type: "spawn", function: "vector", args: [912, 90, 380, 380, 350, 2000] },
			{ type: "spawn", function: "vector", args: [912, 90, 370, 370, 400, 2000] },
		...
		// Debuff
		"ae-0-0-31031011": [{ type: "text", message: "Debuff Stack" }],
		"am-3103-1000-31031011": [{ type: "text", message: "Debuff Stack" }],
		"am-3103-1000-31031012": [{ type: "text", message: "Debuff Stack" }]
	};
