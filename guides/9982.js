...
exports.guide = (mod, extras) => {
	...
	return {
		...
		"s-982-2000-114-0": [{ type: "text", message: "Get In" },
			{ type: "spawn", function: "circle", args: [false, 553, 0, 0, 10, 260, 3000] }],
		...
		"s-982-3000-146-0": [{ type: "text", message: "Left Rear (Pulses)" },
			...
			{ type: "spawn", function: "circle", args: [false, 445, 215, 370, 10, 160, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 215, 370, 10, 320, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 215, 370, 10, 480, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 215, 370, 10, 640, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 215, 370, 10, 800, 8000], delay: 2500 },
		...
		"s-982-3000-148-0": [{ type: "text", message: "Right Rear (Pulses)" },
			...
			{ type: "spawn", function: "circle", args: [false, 445, 155, 388, 10, 160, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 155, 388, 10, 320, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 155, 388, 10, 480, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 155, 388, 10, 640, 8000], delay: 2500 },
			{ type: "spawn", function: "circle", args: [false, 445, 155, 388, 10, 800, 8000], delay: 2500 },
