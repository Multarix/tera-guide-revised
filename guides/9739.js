...
module.exports = (mod) => {
	return {
		...
		"s-739-1000-308-0": [{ "type": "text", "message": "In then Out" },
			{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 10, 300, 0, 7500] }],
		...
		"s-739-2000-105-0": [{ "type": "text", "message": "360" },
			{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 10, 300, 0, 2500] },
			{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 10, 510, 0, 2500] }],
		...
		"s-739-2000-115-0": [{ "type": "text", "message": "Whirlwind" },
			{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 10, 360, 0, 6500] }],
		...
		"s-739-3000-115-0": [{ "type": "text", "message": 'Incoming Stun' },
			{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 10, 630, 0, 4000] },
