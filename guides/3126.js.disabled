...
function skilld_event(skillid, handlers, event, ent, dispatch){
	...
	if([212, 213, 214, 215].includes(skillid)){
		boss_ent = ent;
		spawn.circle(false, 445, 0, 0, 8, 440, 200, 11000, handlers, event, ent, dispatch);
		spawn.circle(false, 445, 0, 0, 4, 840, 200, 11000, handlers, event, ent, dispatch);
	}
	if([212, 214].includes(skillid)){ // Fire claw (141,  142)
		boss_offset = 10;
		spawn.vector(553, 0, 0, 190, 840, 200, 11000, handlers, event, ent, dispatch);
		spawn.vector(553, 0, 0, 10, 840, 200, 11000, handlers, event, ent, dispatch);
	}
	if([213, 215].includes(skillid)){ // Ice claw (143,  144)
		boss_offset = -10;
		spawn.vector(553, 0, 0, 170, 840, 200, 11000, handlers, event, ent, dispatch);
		spawn.vector(553, 0, 0, 350, 840, 200, 11000, handlers, event, ent, dispatch);
	}
...
const skills = {
	...
	// AOE лед (малый)
	"154-0": [{ "type": "text", "message": "Ice Storm" }, { "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 8, 500, 0, 6000] }],
	// AOE огонь (малый)
	...
	"s-3126-1000-1212-0": [{ "type": "function", "function": skilld_event[212] }],
	"s-3126-1000-1215-0": [{ "type": "function", "function": skilld_event[215] }],
	"s-3126-1000-1213-0": [{ "type": "function", "function": skilld_event[213] }],
	"s-3126-1000-1214-0": [{ "type": "function", "function": skilld_event[214] }],
	"qb-3126-1000-3026005": [{ "type": "function", "function": skilld_event[3026005] }], // ужас, одинаковые цвета
	"qb-3126-1000-3026004": [{ "type": "function", "function": skilld_event[3026004] }], // ярость, разные цвета
	"qb-3126-1000-3126005": [{ "type": "function", "function": skilld_event[3126005] }], // ужас, одинаковые цвета
	"qb-3126-1000-3126004": [{ "type": "function", "function": skilld_event[3126004] }], // ярость, разные цвета
	"ae-0-0-99020020": [{ "type": "function", "function": skilld_event[99020020] }],
	"am-3126-1000-30260001": [{ "type": "function", "function": skilld_event[30260001] }], // красный
	"am-3126-1000-30260002": [{ "type": "function", "function": skilld_event[30260002] }], // синий
	"am-3126-1000-31260001": [{ "type": "function", "function": skilld_event[31260001] }], // красный
	"am-3126-1000-31260002": [{ "type": "function", "function": skilld_event[31260002] }], // синий
