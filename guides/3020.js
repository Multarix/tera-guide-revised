...
function skilld_event(skillid, handlers, event, ent, dispatch){
	...
	if(skillid == 121){
		green = true;
		// круг перед боссом
		spawn.circle(true, 553, 0, 170, 8, 290, 3000, 2000, handlers, event, ent, dispatch); // 1
		// бублик вокруг босса
		spawn.circle(true, 553, 0, 0, 8, 280, 4000, 3000, handlers, event, ent, dispatch); // 2
		spawn.circle(true, 553, 0, 0, 4, 570, 4000, 3000, handlers, event, ent, dispatch); // 2
	}
	// (фиолетовый) "Проваливай!"
	if(skillid == 122){
		purple = true;
		// бублик вокруг босса
		spawn.circle(true, 553, 0, 0, 8, 280, 3000, 2000, handlers, event, ent, dispatch); // 1
		spawn.circle(true, 553, 0, 0, 4, 570, 3000, 2000, handlers, event, ent, dispatch); // 1
		// круг перед боссом
		spawn.circle(true, 553, 0, 170, 8, 290, 4000, 3000, handlers, event, ent, dispatch); // 2
	}
	// "Упади в бездну"
	if(skillid == 120){
		...
		if(purple && !boss_thirty){
			...
			// бублик перед боссом
			spawn.circle(true, 912, 0, 150, 8, 280, 5000, 3000, handlers, event, ent, dispatch); // 3
			spawn.circle(true, 912, 0, 150, 4, 570, 5000, 3000, handlers, event, ent, dispatch); // 3
		...
		// к нему (бублик вокруг босса) -> от него (круг перед боссом) -> [волны] -> к нему (бублик перед боссом)
			...
			// бублик перед боссом
			spawn.circle(true, 912, 0, 150, 8, 280, 5000, 5000, handlers, event, ent, dispatch); // 3
			spawn.circle(true, 912, 0, 150, 4, 570, 5000, 5000, handlers, event, ent, dispatch); // 3
			dispatch.setTimeout(() => purple = false, 2000);
		}
	}
	// "Ощути силу взрыва"
	if(skillid == 123){
		...
		if(green && !boss_thirty){
			...
			spawn.circle(true, 912, 0, 200, 8, 450, 5000, 3000, handlers, event, ent, dispatch); // 3
		...
		// от него (круг перед боссом) -> к нему (бублик вокруг босса) -> [волны] -> от него (большой круг перед боссом)
			...
			// большой круг перед боссом
			spawn.circle(true, 912, 0, 200, 8, 450, 5000, 5000, handlers, event, ent, dispatch); // 3
			dispatch.setTimeout(() => purple = false, 2000);
	...
	if(skillid == 127){
		if(boss_thirty){
			...
			spawn.circle(true, 553, 0, 0, 15, 200, 250, 1000, handlers, event, ent, dispatch);
			spawn.circle(true, 553, 0, 0, 10, 300, 1000, 4000, handlers, event, ent, dispatch);
		}
	}
}
...
module.exports = (mod) => {
	return {
		...
		"s-3020-1900-104-0": [{ "type": "text", "message": "Suction (Dodge)" },
			{ "type": "function", "function": spawn.circle, "args": [true, 553, 0, 0, 15, 450, 200, 6000] }],
		...
		"s-3020-2200-108-0": [{ "type": "text", "message": "Front Stun" },
			{ "type": "function", "function": spawn.circle, "args": [true, 553, 0, 170, 20, 120, 200, 2000] }],
		...
		"s-3020-2200-121-0": [{ "type": "function", "function": skilld_event[121] }], // "Ближе!" (зеленый)
		"s-3020-2200-122-0": [{ "type": "function", "function": skilld_event[122] }], // "Проваливай!" (фиолетовый)
		"s-3020-2200-120-0": [{ "type": "function", "function": skilld_event[120] }], // "Упади в бездну"
		"s-3020-2200-123-0": [{ "type": "function", "function": skilld_event[123] }], // "Ощути силу взрыва"
		...
		// "s-3020-2201-121-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "2201-121" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-2201-125-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "2201-125" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-2201-126-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "2201-126" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-2201-201-0": [{ "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-6103-203-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "6103-203" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-6103-202-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "6103-202" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		// "s-3020-6103-201-0": [{ "type": "text", "message": 'Left swipe', "message_TW": "6103-201" }, { "type": "function", "function": spawn.marker, "args": [false, 0, 0, 100, 2000, true, null] }],
		"s-3020-2200-127-0": [{ "type": "function", "function": skilld_event[127] }],
		"s-3020-2200-128-0": [{ "type": "text", "message": "Uppercut (Knockup)" }],
		"s-3020-2200-129-0": [{ "type": "text", "message": "Hammer Toss ~ Skull" },
			{ "type": "function", "function": spawn.vector, "args": [553, 90, 100, 0, 500, 200, 2000] },
			{ "type": "function", "function": spawn.vector, "args": [553, 270, 100, 0, 500, 200, 2000] }],
		// "s-3020-2200-131-0": [{ "type": "text", "message": "Jump" }],
		"s-3020-2200-133-1": [{ "type": "text", "message": "Donuts" },
			{ "type": "function", "function": spawn.circle, "args": [true, 445, 0, 0, 10, 300, 200, 5000] },
			{ "type": "function", "function": spawn.circle, "args": [true, 445, 0, 0, 6, 600, 200, 5000] },
			{ "type": "function", "function": spawn.circle, "args": [true, 445, 0, 0, 4, 900, 200, 5000] }],
