...
module.exports = (mod) => {
	return {
		...
		// "s-3101-1000-121-0": [{ "type": "text", "class_position":"tank", "message": "Right" }],
		// "s-3101-1000-122-0": [{ "type": "text", "class_position":"tank", "message": "Left" }],
		"s-3101-1000-124-0": [{ "type": "text", "class_position":"tank", "sub_type": "msgcg", "message": "Stun Attack" }],
		"s-3101-1000-127-0": [{ "type": "text", "class_position":"dps", "message": "Back" },
			{ "type": "text", "class_position":"heal", "message": "Back" }],
		// "s-3101-1000-128-0": [{ "type": "text", "class_position":"tank", "message": "Triple Attack" }],
		"s-3101-1000-131-0": [{ "type": "text", "class_position":"dps", "message": "Ranged DPS attention" },
			{ "type": "text", "class_position":"heal", "message": "Ranged DPS Attention" }],
		...
		// "s-3101-1000-141-0": [{ "type": "text", "class_position":"tank" }],
		// "s-3101-1000-142-0": [{ "type": "text", "class_position":"tank" }],
		...
		// "s-3101-2000-101-0": [{ "type": "text", "class_position":"tank", "message": "right left" }],
		// "s-3101-2000-102-0": [{ "type": "text", "class_position":"tank", "message": "left right" }],
		// "s-3101-2000-103-0": [{ "type": "text", "class_position":"tank", "message": "spin" }],
		// "s-3101-2000-104-0": [{ "type": "text", "class_position":"tank", "message": "right" }],
		// "s-3101-2000-105-0": [{ "type": "text", "class_position":"tank", "message": "front" }],
		// "s-3101-2000-107-0": [{ "type": "text", "class_position":"tank", "message": "left" }],
		"s-3101-2000-108-0": [{ "type": "text", "message": "Back Attack!" }],
		// "s-3101-2000-109-0": [{ "type": "text", "class_position":"tank", "message": "quaternion Attack" }],
