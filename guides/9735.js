...
exports.guide = (mod, extras) => {
	return {
		...
		"s-735-3000-116-0": [{ type: "text", message: "Right Safe" },
			...
			{ type: "spawn", function: "vector", args: [553, 170, 210, 180, 290, 3000] },
		...
		"s-735-3000-117-0": [{ type: "text", message: "Left Safe" },
			{ type: "spawn", function: "vector", args: [553, 10, 210, 0, 290, 3000] },
			...
			{ type: "spawn", function: "vector", args: [553, 190, 210, 180, 290, 3000] }],
