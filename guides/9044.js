...
exports.guide = (mod, extras) => {
	...
	function skilld_event(skillid, ent){
		...
		if([1121, 2121, 1140, 2140, 1123, 2123, 1142, 2142, 1122, 2122, 1141, 2141].includes(skillid)){
			extras.eventHandler(mod, extras, [{ type: "spawn", function: "vector", args: [553, 90, 50, 0, 500, 6000] },
				...
				{ type: "spawn", function: "circle", args: [false, 445, 0, 0, 10, 400, 6000] },
	...
	return {
		...
		"s-444-1000-2103-0": [{ type: "text", message: "Front (Dodge)" },
			{ type: "spawn", function: "circle", args: [false, 445, 356, 400, 10, 350, 3000], delay: 100 }],
		"s-444-1000-2108-0": [{ type: "text", message: "Back Throw | Front" }],
		"s-444-1000-2111-0": [{ type: "text", message: "Back" },
			{ type: "spawn", function: "circle", args: [false, 445, 180, 500, 10, 480, 2000], delay: 100 }],
		...
		"s-444-1000-2116-0": [{ type: "text", message: "Donuts" },
			{ type: "spawn", function: "circle", args: [false, 553, 0, 0, 10, 290, 6000], delay: 100 }],
		...
		"s-444-1000-2131-0": [{ type: "text", message: "Front | Left Scratch" },
			{ type: "spawn", function: "circle", args: [false, 445, 358, 340, 10, 660, 4000], delay: 100 },
		...
		"s-444-1000-2139-0": [{ type: "text", message: "Dodge!" },
			{ type: "spawn", function: "circle", args: [false, 912, 0, 0, 10, 160, 2000] },
			{ type: "spawn", function: "circle", args: [false, 912, 0, 0, 10, 220, 2000] },
			{ type: "spawn", function: "circle", args: [false, 912, 0, 0, 10, 300, 2000] },
			{ type: "spawn", function: "circle", args: [false, 912, 0, 0, 10, 360, 2000] }],
