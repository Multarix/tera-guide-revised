...
exports.guide = (mod, extras) => {
	...
	return {
		...
		"s-3203-1000-114-0": [{ type: "text", message: "Leap (Knockdown)" }, { type: "spawn", function: "circle", args: [true, 553, 0, 0, 12, 240, 2000] }],
		// "s-3203-1000-154-0": [{ type: "text", message: "Jumping Kick" }], // 154 310 116
		"s-3203-1000-310-0": [{ type: "text", message: "Back Flip | Haymaker" }, { type: "function", function: skilld_event, args: [310] }], // 310 116
		"s-3203-1000-116-0": [{ type: "function", function: skilld_event, args: [116] }], // Haymaker
