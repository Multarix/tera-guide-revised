...
function spawn_marker(out, handlers, dispatch){
	...
	spawn.marker(false, 45 + boss_offset, distance, 0, 4000, true, [caption, "SAFE"], handlers, null, boss_ent, dispatch);
	spawn.marker(false, 135 + boss_offset, distance, 0, 4000, true, [caption, "SAFE"], handlers, null, boss_ent, dispatch);
	spawn.marker(false, 225 + boss_offset, distance, 0, 4000, true, [caption, "SAFE"], handlers, null, boss_ent, dispatch);
	spawn.marker(false, 315 + boss_offset, distance, 0, 4000, true, [caption, "SAFE"], handlers, null, boss_ent, dispatch);
}
...
function skilld_event(skillid, handlers, event, ent, dispatch){
	...
	if([212, 213, 214, 215].includes(skillid)){
		boss_ent = ent;
		spawn.circle(false, 445, 0, 0, 8, 440, 200, 8000, handlers, event, ent, dispatch);
		spawn.circle(false, 445, 0, 0, 4, 840, 200, 8000, handlers, event, ent, dispatch);
	}
	if([212, 214].includes(skillid)){ // Fire claw (141, 142)
		boss_offset = 10;
		spawn.vector(553, 0, 0, 190, 840, 200, 8000, handlers, event, ent, dispatch);
		spawn.vector(553, 0, 0, 10, 840, 200, 8000, handlers, event, ent, dispatch);
	}
	if([213, 215].includes(skillid)){ // Ice claw (143, 144)
		boss_offset = -10;
		spawn.vector(553, 0, 0, 170, 840, 200, 8000, handlers, event, ent, dispatch);
		spawn.vector(553, 0, 0, 350, 840, 200, 8000, handlers, event, ent, dispatch);
	}
	if([213, 214].includes(skillid)){ // Ice inside
		dispatch.setTimeout(() => {
			if(debuff != null){
				handlers["text"]({
					"sub_type": "message",
					"message": (`Ice inside (${qbacting_messages[qbacting].msgt}) | ${mech_messages[(qbacting + debuff + 1) % 2].msgt}`),
					"message_RU": (`Внутри лед (${qbacting_messages[qbacting].msg}) | ${mech_messages[(qbacting + debuff + 1) % 2].msg}`)
				});
				spawn_marker((qbacting + debuff + 1) % 2, handlers, dispatch);
			} else {
				handlers["text"]({
	...
	if([212, 215].includes(skillid)){ // Fire inside
		dispatch.setTimeout(() => {
			if(debuff != null){
				handlers["text"]({
					"sub_type": "message",
					"message": (`Fire inside (${qbacting_messages[qbacting].msgt}) | ${mech_messages[(qbacting + debuff) % 2].msgt}`),
					"message_RU": (`Внутри огонь (${qbacting_messages[qbacting].msg}) | ${mech_messages[(qbacting + debuff) % 2].msg}`)
				});
				spawn_marker((qbacting + debuff) % 2, handlers, dispatch);
			} else {
				handlers["text"]({
	...
	if(!debuff_tracker_started){
		dispatch.hook("S_ABNORMALITY_BEGIN", 4, abnormality_change[true]);
		dispatch.hook("S_ABNORMALITY_END", 1, abnormality_change[false]);
...
const skills = {
	...
	"108-0": [{ "type": "text", "message": "Turn Right (Repel)" },
		{ "type": "function", "function": spawn.circle, "args": [false, 912, 0, 0, 8, 440, 0, 2000] }],
	...
	"103-0": [{ "type": "text", "message": "Tail (Flying)" },
		...
		{ "type": "function", "function": spawn.semi, "args": [140, 260, 912, 0, 0, 10, 500, 0, 2000] },
		{ "type": "function", "function": spawn.vector, "args": [912, 0, 0, 135, 500, 0, 2000] },
		{ "type": "function", "function": spawn.vector, "args": [912, 0, 0, 260, 500, 0, 2000] }],
	...
	"104-0": [{ "type": "text", "message": "Ice Storm DOTs" },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 8, 500, 0, 5000] }],
	// AOE огонь (большой)
	"105-0": [{ "type": "text", "message": "Fire Bombs" },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 135, 500, 10, 270, 0, 3000] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 315, 500, 10, 270, 0, 3250] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 45, 500, 10, 270, 0, 3500] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 235, 500, 10, 270, 0, 3750] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 90, 500, 10, 270, 0, 4000] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 270, 500, 10, 270, 0, 4250] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 500, 10, 270, 0, 4500] },
		{ "type": "function", "function": spawn.circle, "args": [false, 553, 180, 500, 10, 270, 0, 4750] }],
	// AOE лед (малый)
	...
	"206-2": [{ "type": "function", "function": spawn.circle, "args": [false, 553, 0, 0, 15, 350, 0, 3000] }],
	...
	"s-3026-1000-1212-0": [{ "type": "function", "function": skilld_event[212] }],
	"s-3026-1000-1215-0": [{ "type": "function", "function": skilld_event[215] }],
	"s-3026-1000-1213-0": [{ "type": "function", "function": skilld_event[213] }],
	"s-3026-1000-1214-0": [{ "type": "function", "function": skilld_event[214] }],
	"qb-3026-1000-3026005": [{ "type": "function", "function": skilld_event[3026005] }], // ужас, одинаковые цвета
	"qb-3026-1000-3026004": [{ "type": "function", "function": skilld_event[3026004] }], // ярость, разные цвета
	"qb-3026-1000-3126005": [{ "type": "function", "function": skilld_event[3126005] }], // ужас, одинаковые цвета
	"qb-3026-1000-3126004": [{ "type": "function", "function": skilld_event[3126004] }], // ярость, разные цвета
	"ae-0-0-99020020": [{ "type": "function", "function": skilld_event[99020020] }],
	"am-3026-1000-30260001": [{ "type": "function", "function": skilld_event[30260001] }], // красный
	"am-3026-1000-30260002": [{ "type": "function", "function": skilld_event[30260002] }], // синий
	"am-3026-1000-31260001": [{ "type": "function", "function": skilld_event[31260001] }], // красный
	"am-3026-1000-31260002": [{ "type": "function", "function": skilld_event[31260002] }] // синий
};
